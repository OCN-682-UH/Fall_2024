...
Why did should you be careful with ChatGPT?
...
Make some simple code with your neighbors and add a bug.  Use datapasta and reprex to make a reproducible example and post it to our slack channel. Make sure to add your session info. 

Someone in a different area has to find the error and offer a useable solution.
